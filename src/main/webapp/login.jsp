	...
	<div class="logo_box">
		...
		<form action="" name="f" method="post" onsubmit="return condition(this)">
			<div class="input_outer">
				...
				<input name="useraccount" class="text" placeholder="输入账号登录" style="color: #FFFFFF !important" type="text">
			</div>
			<div class="input_outer">
			...
			<input type="checkbox" name="savesid" value="0" id="check-box" class="checkbox" title="remember"><span>记住账号</span>
			<a href="#" class="login-fgetpwd" style="color: #FFFFFF">忘记密码？</a>
		</form>


		<div class="sas">
			还没注册账号，请先<a href="register.jsp">&nbsp;注册</a>&nbsp;账号！
		</div>
	</div>
